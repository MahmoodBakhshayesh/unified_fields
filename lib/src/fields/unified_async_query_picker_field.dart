...
class _UnifiedAsyncQueryPickerState<T> extends State<UnifiedAsyncQueryPicker<T>> {
  ...
  void _syncFieldController() {
    ...
    widget.fieldController?.queryFetcher = widget.queryFetcher;
    widget.fieldController?.queryThreshold = widget.queryThreshold;
    widget.fieldController?.queryDebounce = widget.queryDebounce;
